...
import { Inbox, Settings2, Archive, FolderOpen, BarChart3, History } from "lucide-react";
...
const TABS = [
  ...
  { href: "/correspondencia/reportes", label: "Reportes", icon: BarChart3, permiso: "admin" as const },
