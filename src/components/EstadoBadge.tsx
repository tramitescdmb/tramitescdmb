const ESTILOS: Record<string, string> = {
  ...
  SUSPENDIDO: "bg-gray-100 text-gray-600 ring-gray-500/20",
  APROBADO: "bg-green-50 text-green-700 ring-green-600/20",
  NEGADO: "bg-red-50 text-red-700 ring-red-600/20",
  DESISTIDO: "bg-gray-100 text-gray-500 ring-gray-500/20",
  ARCHIVADO: "bg-gray-100 text-gray-500 ring-gray-500/20",
...
export function EstadoBadge({ estado }: { estado: string }) {
  const clase = ESTILOS[estado] ?? "bg-gray-100 text-gray-600 ring-gray-500/20";
