    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <Link
          ...
          className="group flex flex-none flex-col items-center gap-0.5 rounded-lg border border-cdmb-200 bg-white px-3.5 py-2 text-cdmb-700 shadow-sm transition hover:border-cdmb-400 hover:bg-cdmb-50"
        >
          <HelpCircle className="h-5 w-5" aria-hidden />
          <span className="text-[10px] font-semibold uppercase tracking-wide">Ayuda</span>
        </Link>
      </div>
