  ...
  const c = await db.comunicacion.findUnique({
    ...
    select: {
      ...
      firmas: {
        ...
        include: {
          usuario: {
            select: { nombre: true, denominacionEmpleo: true, denominacionComplemento: true, sexo: true, dependencia: { select: { nombre: true } } },
          },
        },
      },
    },
  ...
  return (
    <section className="mx-auto max-w-3xl space-y-4">
      ...
      <div className="rounded-xl border border-stone-200 bg-white p-5 shadow-sm">
        ...
        {c.firmas.length === 0 ? (
          <p className="mt-4 text-sm text-stone-400">Esta comunicación no tiene firmas registradas.</p>
        ) : (
