...
export default async function CalendarioLaboralPage({ searchParams }: { searchParams: Promise<{ ok?: string; error?: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <div>
        <h1 className="text-xl font-semibold text-stone-900">Calendario laboral</h1>
        <p className="text-sm text-stone-500">
          Define la jornada de la entidad y los días compensados o cierres institucionales. Alimenta el
      ...
      <section className="rounded-xl border border-stone-200 bg-white p-4">
        <h2 className="flex items-center gap-2 text-sm font-semibold text-stone-900">
          <CalendarOff className="h-4 w-4 text-cdmb-600" aria-hidden /> Días no laborados de la entidad
        </h2>
        <SectionHelp>
      ...
      <section className="rounded-xl border border-stone-200 bg-white p-4">
        <h2 className="text-sm font-semibold text-stone-900">Festivos de ley {anio} (referencia)</h2>
