...
export default async function DashboardContratacionPage() {
  ...
  return (
    <section className="space-y-4">
      <TituloSeccion icon={LayoutDashboard}>Dashboard de Contratación</TituloSeccion>
          ...
          <div className="mb-1 flex flex-wrap items-baseline justify-between gap-2">
            ...
            {vista.totalFirmasCompletadas > 0 && (
              <span className="text-xs text-stone-500">
                Tardan en promedio{" "}
                <strong className="tabular-nums text-stone-800">{vista.tiempoResolucionFirmas} días</strong>
              </span>
            )}
          </div>
