                  ...
                  {ordenarPorCalidad(doc.firmas, (f) => f.calidad).map((f) => {
                    ...
                    <li key={f.id} className={`rounded-lg border border-stone-100 bg-stone-50/60 ${rotuloCalidadFirma(f.calidad) ? "p-2.5 text-xs" : "p-3 text-sm"}`}>
                      ...
                      <dl className="mt-2 grid grid-cols-1 gap-x-4 gap-y-1 text-xs sm:grid-cols-2">
                        ...
                        <Dato k={etiquetaDatoIdentificacion(identidad.tipoIdentificacion)} v={identidad.cedulaONit ?? "no registrada"} mono />
                  ...
                  {doc.solicitudesFirma.map((s) => {
                    ...
                    <li key={s.id} className="rounded-lg border border-sky-100 bg-sky-50/50 p-2 text-xs">
                      ...
                      <dl className="mt-2 grid grid-cols-1 gap-x-4 gap-y-1 text-xs sm:grid-cols-2">
                        ...
                        <Dato k={etiquetaDatoIdentificacion(identidadVb.tipoIdentificacion)} v={identidadVb.cedulaONit ?? "no registrada"} mono />
