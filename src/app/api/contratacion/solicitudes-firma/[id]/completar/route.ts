...
/** Completa (firma/da visto bueno) una solicitud de firma de contratación asignada al usuario
 * que llama esta ruta — captura IP/user-agent reales, requeridos por la ficha técnica de firma. */
