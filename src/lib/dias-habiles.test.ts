...
describe("festivosColombia", () => {
  it("incluye los festivos fijos de 2025", () => {
    ...
    expect(f.has("2025-01-01")).toBe(true);
    expect(f.has("2025-05-01")).toBe(true);
    expect(f.has("2025-07-20")).toBe(true);
    expect(f.has("2025-08-07")).toBe(true);
    expect(f.has("2025-12-08")).toBe(true);
    expect(f.has("2025-12-25")).toBe(true);
  });
...
describe("esFinDeSemana / esDiaHabil", () => {
  it("sábado y domingo no son hábiles", () => {
    expect(esFinDeSemana(d("2025-01-04"))).toBe(true);
    expect(esFinDeSemana(d("2025-01-05"))).toBe(true);
...
describe("CalendarioLaboral (jornada + días no laborados de la entidad)", () => {
  it("un día compensado de la entidad no cuenta como hábil", () => {
    ...
    expect(esDiaHabil(d("2025-01-15"))).toBe(true);
  ...
  it("si la entidad no labora viernes, el viernes no es hábil", () => {
    ...
    expect(esDiaHabil(d("2025-01-03"), cal)).toBe(false);
  });
});
